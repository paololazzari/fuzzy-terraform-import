...
// Disable test because availiabiliy zone is not yet implemented by moto
...
// func TestEC2PlacementGroupProperties(t *testing.T) {
// 	region := "us-east-1"
// 	profile := "local"
...
// 	obj := fuzzyec2.EC2PlacementGroupProperties(svc)
// 	assert := assert.New(t)
...
// 	assert.NotEmpty(obj[0]["OptInStatus"], "OptInStatus should not be empty")
// }
